...
**1-** Download xash_lan from [here](https://github.com/happyhere-2N/XASH_LAN_MOBILE/releases/download/xash_lan_mobile/xash_lan_+gamemods.zip) and extract it on download folder on mobile and install all the apks u find
